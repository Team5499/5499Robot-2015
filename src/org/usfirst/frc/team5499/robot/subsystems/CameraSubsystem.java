...
public class CameraSubsystem extends Subsystem {
	...
	double SCORE_MIN = 74.0; 	//Minimum score to be considered a tote
...
//		NIVision.IMAQdxConfigureGrab(session);
	...
	public void Execute() {
		...
		if(numParticles > 0)
		{
			...
			//^ should be done
			//TODO test that the above has been indeed achieved
			...
			this.isTote = (scores1.Aspect > SCORE_MIN && scores1.Area > SCORE_MIN) && (scores2.Aspect >SCORE_MIN && scores2.Area > SCORE_MIN);
